window.POSTS_DATA = {
  "posts": [
    ...
    },
    {
      ...
      "tags": ["AI역량", "스킬감소", "앤트로픽", "인재전략", "생존"],
      "slug": "2026-02-01-ai-skill-erosion-anthropic-study",
      "file": "survival/2026-02-01-ai-skill-erosion-anthropic-study.html",
      "summary": "앤트로픽이 개발자 52명을 실험한 결과, AI 보조를 쓴 그룹은 학습 점수가 17% 낮았고 속도도 빨라지지 않았다. 생산성이라는 이름 뒤에 실력 저하가 숨어 있다.",
    ...
    },
    {
      ...
      "tags": ["SAP", "ERP", "레거시", "AI에이전트", "엔터프라이즈", "디지털전환"],
    ...
    },
    {
      ...
      "summary": "다보스 2026에서 구글 딥마인드 하사비스와 앤트로픽 아모데이가 AGI 타임라인부터 일자리 소멸까지 정면 토론. 경영 리더가 알아야 할 핵심 정리.",
