...
- **제목**: 한국어 **명사구 헤드라인**. 40자 이내, 20~30자 목표.
  - **서술 종결 금지**: `~습니다`, `~입니다`, `~하세요`, `~십시오`로 끝내지 않는다. 계사 `~이다`, `~였다`도 금지.
  - **명사구 또는 압축 서술로 끝낸다.** 예: "에이전트 240만 요청, 성공은 117건" / "같은 검색창이 지운 전문가의 안목" / "발견은 일주일, 검증은 한 달"
  - **금지 공식 3가지**: 대구 반복("A는 오르고 B는 내립니다"), 반전 공식("~라던 AI, ~했습니다"), 2인칭 호출("당신이 쓰는 AI")
  - 숫자와 고유명사는 살린다. 본문 종결어미(`~입니다`)와 제목 문체는 별개다.
- **카테고리**: 5개 중 선택
